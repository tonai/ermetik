...
if (isset($_POST['pseudo']))
{
	if ($_POST['pseudo']!='' and $_POST['comm']!='')
	{
		...
		mysqli_close($mysqli);
		echo "<p>Votre message a bien �t� enregistr�</p>\n";
	}
}
?>
	<p>
...
<?php
	...
	if ($pageActuelle!=1)
	{
		...
		echo "\n\t<a href=\"index.php?bouton=".!$on."&module=commentaires&page=".$pagePrec."\" title=\"page pr�c�dante\"><</a>&nbsp&nbsp;";
	}
	echo "\n\t<a href=\"index.php?bouton=".!$on."&module=commentaires&page=1\" title=\"premi�re page\">1..</a>&nbsp&nbsp;";
	$i=2;
	if ($pageActuelle<=5)
	{
		$i=2;
	...
	if ($pagesTotales!=1)
		echo "\n\t<a href=\"index.php?bouton=".!$on."&module=commentaires&page=".$pagesTotales."\" title=\"derni�re page\">..".$pagesTotales."</a>&nbsp&nbsp;";
