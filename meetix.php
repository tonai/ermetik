...
<?php
  ...
  /*
	...
	if ($pageActuelle!=1)
	{
		...
		echo "\n\t<a href=\"index.php?bouton=".!$on."&module=meetix&page=".$pagePrec."\" title=\"page pr�c�dante\"><</a>&nbsp&nbsp;";
	}
	echo "\n\t<a href=\"index.php?bouton=".!$on."&module=meetix&page=1\" title=\"premi�re page\">1..</a>&nbsp&nbsp;";
	$i=2;
	if ($pageActuelle<=5)
	{
		$i=2;
	...
	if ($pagesTotales!=1)
		echo "\n\t<a href=\"index.php?bouton=".!$on."&module=meetix&page=".$pagesTotales."\" title=\"derni�re page\">..".$pagesTotales."</a>&nbsp&nbsp;";
